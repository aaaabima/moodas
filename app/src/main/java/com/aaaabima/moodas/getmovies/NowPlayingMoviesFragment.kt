...
class NowPlayingMoviesFragment : BaseBindingFragment<FragmentNowPlayingMoviesBinding>() {
    ...
    @Inject
    lateinit var presenter: NowPlayingMoviesPresenter
    ...
    private fun initInjector() {
        DaggerNowPlayingMoviesComponent.builder()
            .applicationComponent(getApplicationComponent())
            .nowPlayingMoviesModule(getNowPlayingMoviesModule())
            .build()
            .inject(this)
    ...
    private fun initRecyclerView() {
        binding.rvItemMovie.apply {
            layoutManager = GridLayoutManager(this@NowPlayingMoviesFragment.context, 2)
    ...
    private fun getNowPlayingMoviesModule() =
        NowPlayingMoviesModule(object : NowPlayingMoviesContract.View {
    ...
    companion object {
        ...
        fun newInstance(): NowPlayingMoviesFragment = NowPlayingMoviesFragment()
    }
}